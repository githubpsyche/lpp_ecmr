...
This association functions bidirectionally: recalling an item reinstates its associated context, which can then cue further recall.
...
@polyn2009context extended retrieved-context theory to include nontemporal dimensions of context, including semantic similarity (pre-experimental associations between stimuli) and experiential similarity (shared encoding processes during the session itself).
...
A recent variant of retrieved-context theory, emotional Context-Maintenance and Retrieval [@talmi2019retrieved] (eCMR), extends CMR in two ways: by introducing an emotional dimension of context and by allowing emotion to modulate encoding strength, capturing the effects of emotional similarity and preferential attention, respectively.
<!-- FIXME: this sentence is too long and complex, probably challenging for new readers to appreciate. -->
...
Changes in LPP amplitudes due to affective significance have been observed at the group level across a range of stimuli and presentation durations.
...
Recently, @schupp2021case examined this question using a case-by-case approach across three studies with different emotional stimulus categories.
They observed that the LPP was larger for high- compared to low-arousing stimuli in 98% of cases.
