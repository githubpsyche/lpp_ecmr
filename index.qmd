...
:::: {#tbl-talmi-parameter-estimates tbl-colwidths="[34,22,22,22]"}
...
Parameter estimates and fit summaries for TalmiEEG model variants (mean +/- 95% t-based CI across participants).
::::

@tbl-talmi-delta-aic reports pairwise delta AIC values used in the comparisons above.

:::: {#tbl-talmi-delta-aic tbl-colwidths="[34,22,22,22]"}
...
Pairwise delta AIC (row minus column; mean \[95% t-based CI\]).
::::
