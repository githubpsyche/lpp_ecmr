...
`work/pooled_model_runs/` into the numerical tables and diagnostic summaries
...
```bash
python3 work/pooled_model_summaries/build_results.py
```
...
`work/pooled_model_figures/` reports the derived EEG outcome on its
